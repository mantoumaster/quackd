...
The `alohamini` robot adapter for [quackd](https://github.com/rokbenko/quackd). Install it through
...
[docs/adapters/alohamini.md](https://github.com/rokbenko/quackd/blob/main/docs/adapters/alohamini.md).
