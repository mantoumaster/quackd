...
driving the same robot at once. Every real-hardware transport but one is experimental and unverified end to end, and the one that has run, `lerobot:real`, ran for two afternoons on one arm, 2026-09-15 and 2026-09-23
