...
[jetson.md](jetson.md) puts
quackd and a local model beside the ToddlerBot's daemon on one board, as separate processes
over loopback, and none of it becomes the robot's control loop ([ADR-0044](adr/0044-a-jetson-is-a-host-not-a-body.md)).
